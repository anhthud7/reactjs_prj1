...
function Header() {
  ...
  const isLoggedin = localStorage.getItem("isLoggedin") || localStorage.getItem("isLoggedIn");
              ...
              <div className="shop-menu clearfix pull-right">
                <ul className="nav navbar-nav">
                  ...
                  {isLoggedin ? (
                    ...
                    <li><Link to="/member/login-register"><i className="fa fa-lock"></i> Login</Link></li>
                  )}
                </ul>
              </div>
            </div>
